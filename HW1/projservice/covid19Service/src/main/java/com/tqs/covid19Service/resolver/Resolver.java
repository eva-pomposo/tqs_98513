...
public class Resolver {
    ...
    public List<Statistic> convertStringtoHistory(String string){
        ...
        for (int i = 0; i < jo.getJSONArray("response").length(); i++) {
            ...
            if (!jsonObjectResponse.get("population").getClass().getName().equals("org.json.JSONObject$1") && !jsonObjectResponse.get("population").getClass().getName().equals("org.json.JSONObject$Null")) { 
