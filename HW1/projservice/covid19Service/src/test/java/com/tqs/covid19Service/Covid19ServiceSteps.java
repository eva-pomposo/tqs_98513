package com.tqs.covid19Service;
...
public class Covid19ServiceSteps {
...
/*
    ...
    public void chooseDeparture(String departureCity) {
        Select dropdown = new Select(driver.findElement(By.xpath("//*[@id='countryName']")));
...
Feature: Statistics Covid-19
  Allows users to enter or select a region/country and access its Covid metrics

  Scenario: Search statistic by country
    When I navigate to "http://localhost:8080/"
        Then A new page with the tilte "Statistics Covid-19" appears
    When I choose country "Portugal"
