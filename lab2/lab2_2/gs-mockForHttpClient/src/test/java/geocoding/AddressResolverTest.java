...
class AddressResolverTest {
    ...
    void whenResolveAlboiGps_returnCaisAlboiAddress() throws ParseException, IOException, URISyntaxException {
        ...
        when(iHttpClient.doHttpGet("http://open.mapquestapi.com/geocoding/v1/reverse?key=uXSAVwYWbf9tJmsjEGHKKAo0gOjZfBLQ&location=40.640661,-8.656688&includeRoadMetadata=true")).thenReturn(jsonResponse);
